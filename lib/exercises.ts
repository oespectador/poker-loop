...
export const developmentExercises: Exercise[] = [
  ...
  },
  {
    ...
    spot: { label: "Thick Value · range forte", pot: "Premissa do exercício", stack: "100bb", hero: "Herói tem Thick Value", action: ["A leitura aponta para um range relativamente forte"] }, prompt: "Qual erro devemos evitar?", options: [{ id: "retreat", label: "Transformar ‘range forte’ em comando automático de recuar sem considerar a força e a função da própria mão." }, { id: "ignore", label: "Ignorar completamente o range porque a mão é Thick Value." }, { id: "fold", label: "Foldar porque o range é forte." }], correctOptionId: "retreat", feedback: { short: "A força do range entra na decisão, mas não apaga automaticamente uma mão classificada como Thick Value nesta premissa." }, sourceKind: "heuristic", variantGroup: "hand-function-context", learningPackage: "hand-function-vs-range", packageSequence: 4, concept: "hand-function-context", subconcept: "strong-value-boundary", reasoningPattern: "integrate-range-and-hand-function"
  },
  {
...
export const evaluationExercises: Exercise[] = [
  ...
  {
    id: "retention-hand-range-01", purpose: "retention", primarySkill: "integrated-decision", support: "independent", spot: { label: "Retenção · mesma mão", pot: "Comparação", stack: "100bb", hero: "Herói", action: ["A: várias mãos piores continuam", "B: poucas mãos piores continuam"] }, prompt: "A função da mão permanece fixa contra os dois ranges?", options: [{ id: "context", label: "Não. A relação com o range e as mãos-alvo pode mudar sua função." }, { id: "fixed", label: "Sim. As cartas do Herói definem uma função permanente." }], correctOptionId: "context", feedback: { short: "A mesma mão pode cumprir papéis diferentes contra ranges diferentes." }, sourceKind: "heuristic", variantGroup: "hand-function-context", learningPackage: "hand-function-vs-range", concept: "hand-function-context", subconcept: "same-hand-different-range", reasoningPattern: "reclassify-hand-by-range"
  },
  {
    id: "retention-hand-range-02", purpose: "retention", primarySkill: "integrated-decision", support: "independent", spot: { label: "Retenção · Thin Value", pot: "Premissa didática", stack: "100bb", hero: "Herói", action: ["Quase todas as mãos piores deixam de continuar contra a aposta"] }, prompt: "O objetivo de value continua funcionando bem?", options: [{ id: "no", label: "Não muito; faltam mãos piores suficientes continuando." }, { id: "yes", label: "Sim; Thin Value é uma função fixa." }], correctOptionId: "no", feedback: { short: "Value depende das mãos piores que continuam." }, sourceKind: "heuristic", variantGroup: "objective-target-fit", learningPackage: "hand-function-vs-range", concept: "objective-target-fit", subconcept: "thin-value-targets", reasoningPattern: "match-hand-function-to-targets"
  },
  {
    id: "retention-hand-range-03", purpose: "retention", primarySkill: "integrated-decision", support: "independent", spot: { label: "Retenção · Draw e Air", pot: "Premissa didática", stack: "100bb", hero: "Herói", action: ["As mãos melhores relevantes não foldam para a agressão considerada"] }, prompt: "Draw ou Air tornam a agressão automática?", options: [{ id: "function", label: "Não. Agressão precisa de objetivo, mãos-alvo e mudança real na decisão delas." }, { id: "automatic", label: "Sim. Essas categorias exigem agressão." }], correctOptionId: "function", feedback: { short: "A categoria não substitui a função da ação." }, sourceKind: "theory", variantGroup: "objective-target-fit", learningPackage: "hand-function-vs-range", concept: "objective-target-fit", subconcept: "aggression-function", reasoningPattern: "target-before-aggression"
  },
  {
    id: "transfer-hand-range-01", purpose: "transfer", primarySkill: "integrated-decision", support: "independent", spot: { label: "Transferência · novo board multiway", pot: "Flop multiway", stack: "100bb", hero: "Herói tem mão intermediária", board: ["K♣", "9♦", "6♠"], action: ["Várias pistas sustentam range mais forte", "Poucas mãos piores continuam contra uma aposta"] }, prompt: "O que deve ser reavaliado?", options: [{ id: "function", label: "A função da mão e o objetivo, considerando as mãos piores que ainda continuam." }, { id: "fold", label: "Apenas se devemos foldar por enfrentar range forte." }], correctOptionId: "function", feedback: { short: "A nova superfície mantém a estrutura range → mão → função → alvos." }, sourceKind: "heuristic", variantGroup: "hand-function-context", learningPackage: "hand-function-vs-range", concept: "hand-function-context", subconcept: "transfer-stronger-range", reasoningPattern: "reclassify-hand-by-range"
  },
  {
    id: "transfer-hand-range-02", purpose: "transfer", primarySkill: "integrated-decision", support: "independent", spot: { label: "Transferência · value e size", pot: "Premissa didática", stack: "100bb", hero: "Herói tem Thin Value", action: ["Range relativamente fraco", "50%: várias mãos piores pagam", "100%: essas mãos piores abandonam"] }, prompt: "O range mais fraco torna automaticamente o size maior melhor para value?", options: [{ id: "no", label: "Não. O size maior perde justamente as mãos piores que eram alvo de value." }, { id: "yes", label: "Sim. Contra range fraco devemos aumentar o size." }], correctOptionId: "no", feedback: { short: "A resposta das mãos-alvo, não o rótulo do range, decide se o size cumpre o objetivo." }, sourceKind: "theory", variantGroup: "objective-target-fit", learningPackage: "hand-function-vs-range", concept: "objective-target-fit", subconcept: "weaker-range-size-boundary", reasoningPattern: "complete-decision-chain"
  },
  {
    id: "transfer-hand-range-03", purpose: "transfer", primarySkill: "integrated-decision", support: "independent", spot: { label: "Transferência · evidência conflitante", pot: "Nova configuração", stack: "100bb", hero: "Herói na fronteira Thin Value/SDV", action: ["Os sinais de força do range apontam em direções diferentes"] }, prompt: "Qual adaptação é mais calibrada?", options: [{ id: "uncertain", label: "Atualizar a hipótese, preservar a incerteza e evitar uma reclassificação rígida da mão." }, { id: "fixed", label: "Escolher imediatamente Thin Value ou SDV como rótulo definitivo." }], correctOptionId: "uncertain", feedback: { short: "Evidência conflitante sustenta menos adaptação que várias pistas coerentes." }, sourceKind: "heuristic", variantGroup: "range-response-calibration", learningPackage: "hand-function-vs-range", concept: "range-response-calibration", subconcept: "conflicting-signals", reasoningPattern: "calibrate-strategy-update"
  },

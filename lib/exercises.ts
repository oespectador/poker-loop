...
export const developmentExercises: Exercise[] = [
  ...
  {
    id: "dev-hand-range-01", purpose: "development", primarySkill: "integrated-decision", support: "guided",
    spot: { label: "Mesma mão · ranges diferentes", pot: "Comparação didática", stack: "100bb", hero: "Herói", action: ["A: range relativamente fraco; várias mãos piores continuam", "B: mesma mão contra range relativamente forte; poucas mãos piores continuam"] },
    prompt: "O que muda primeiro no raciocínio?", options: [{ id: "reassess", label: "A função prática da mão e seu objetivo precisam ser reavaliados em relação ao novo range." }, { id: "same", label: "Nada muda porque as cartas do Herói são as mesmas." }, { id: "fold", label: "Range forte significa fold automaticamente." }], correctOptionId: "reassess",
    feedback: { short: "A função da mão é contextual: depende do range enfrentado e das mãos-alvo que continuam.", misconception: { same: "As cartas não mudaram, mas a relação da mão com o range mudou.", fold: "Range forte é uma variável, não um comando automático de fold." } }, sourceKind: "heuristic", variantGroup: "hand-function-context", learningPackage: "hand-function-vs-range", packageSequence: 1, concept: "hand-function-context", subconcept: "same-hand-different-range", reasoningPattern: "reclassify-hand-by-range", supportNote: "Compare quais mãos piores continuam em cada cenário."
  },
  {
    id: "dev-hand-range-02", purpose: "development", primarySkill: "integrated-decision", support: "supported",
    spot: { label: "Thin Value contextual", pot: "Premissa didática", stack: "100bb", hero: "Herói", action: ["Contra A, várias mãos piores pagam", "Contra B, quase nenhuma mão pior paga"] }, prompt: "Faz sentido chamar a mão de Thin Value da mesma forma nas duas situações?", options: [{ id: "context", label: "Não. A função depende do range enfrentado e das mãos piores que continuam." }, { id: "fixed", label: "Sim. Thin Value é uma propriedade fixa da mão." }], correctOptionId: "context", feedback: { short: "Thin Value descreve uma função naquela relação entre mão, range e resposta das mãos-alvo; não um rótulo permanente." }, sourceKind: "heuristic", variantGroup: "hand-function-context", learningPackage: "hand-function-vs-range", packageSequence: 2, concept: "hand-function-context", subconcept: "thin-value-context", reasoningPattern: "reclassify-hand-by-range", supportNote: "Pergunte quais mãos piores ainda pagam."
  },
  {
    id: "dev-hand-range-03", purpose: "development", primarySkill: "integrated-decision", support: "supported",
    spot: { label: "SDV pode mudar de papel", pot: "Premissa didática", stack: "100bb", hero: "Herói", action: ["Range forte: poucas mãos piores pagam uma aposta", "Range mais fraco: diversas mãos piores continuam"] }, prompt: "Qual conclusão é mais coerente?", options: [{ id: "change", label: "A mão pode funcionar principalmente como SDV no primeiro contexto e ter mais potencial de valor no segundo." }, { id: "fixed", label: "Se é SDV no primeiro, será apenas SDV contra qualquer range." }, { id: "always-bet", label: "Contra o range mais fraco, ela deve obrigatoriamente apostar." }], correctOptionId: "change", feedback: { short: "A resposta das mãos piores pode mudar o papel da mão, sem tornar a aposta obrigatória." }, sourceKind: "heuristic", variantGroup: "hand-function-context", learningPackage: "hand-function-vs-range", packageSequence: 3, concept: "hand-function-context", subconcept: "sdv-context", reasoningPattern: "reclassify-hand-by-range", supportNote: "Compare a quantidade de mãos piores que continua; não procure uma ação automática."
  },
  {
    id: "dev-hand-range-04", purpose: "development", primarySkill: "integrated-decision", support: "independent",
    spot: { label: "Thick Value · range forte", pot: "Premissa do exercício", stack: "100bb", hero: "Herói tem Thick Value", action: ["A leitura aponta para um range relativamente forte"] }, prompt: "Qual raciocínio integra melhor as duas informações?", options: [{ id: "retreat", label: "Considerar o range mais forte, sem deixar que essa leitura anule por si só a função de Thick Value da mão." }, { id: "ignore", label: "Manter o plano de value sem revisar as mãos-alvo, pois a classificação como Thick Value já incorpora o que importa." }, { id: "fold", label: "Reduzir a mão a bluff catcher, dando à leitura do range mais peso que à função atribuída na premissa." }], correctOptionId: "retreat", feedback: { short: "A decisão integra as duas informações: o range importa, mas não apaga por si só a função de Thick Value fornecida.", misconception: { ignore: "Thick Value não autoriza ignorar o range nem as mãos-alvo da ação.", fold: "A leitura de força merece peso, mas esta opção exagera a adaptação e descarta a função dada à mão." } }, sourceKind: "heuristic", variantGroup: "hand-function-context", learningPackage: "hand-function-vs-range", packageSequence: 4, concept: "hand-function-context", subconcept: "strong-value-boundary", reasoningPattern: "integrate-range-and-hand-function"
  },
  {
    id: "dev-hand-range-05", purpose: "development", primarySkill: "integrated-decision", support: "guided",
    spot: { label: "Thin Value · range mais forte", pot: "Premissa didática", stack: "100bb", hero: "Herói considera apostar", action: ["Mãos melhores continuam", "Quase todas as mãos piores abandonam"] }, prompt: "O objetivo de apostar por Thin Value está funcionando?", options: [{ id: "poor-fit", label: "Não muito. A ação deixou de atingir mãos piores suficientes." }, { id: "fold", label: "Não; portanto a mão deve ser foldada." }, { id: "yes", label: "Sim, porque enfrentar um range forte aumenta o valor da aposta." }], correctOptionId: "poor-fit", feedback: { short: "O problema é o encaixe entre objetivo e mãos-alvo; isso não determina automaticamente fold." }, sourceKind: "heuristic", variantGroup: "objective-target-fit", learningPackage: "hand-function-vs-range", packageSequence: 5, concept: "objective-target-fit", subconcept: "thin-value-stronger-range", reasoningPattern: "match-hand-function-to-targets", supportNote: "Value precisa encontrar mãos piores que continuem."
  },
  {
    id: "dev-hand-range-06", purpose: "development", primarySkill: "integrated-decision", support: "supported",
    spot: { label: "Thin Value · range mais fraco", pot: "Premissa didática", stack: "100bb", hero: "Herói considera o tamanho proposto", action: ["Várias mãos piores continuam contra esse tamanho"] }, prompt: "O que isso muda?", options: [{ id: "coherent", label: "A hipótese de apostar por valor fica mais coerente porque existem mãos piores plausíveis para pagar." }, { id: "automatic", label: "Range fraco torna a aposta obrigatória." }, { id: "raise", label: "Range fraco exige raise, qualquer que seja a resposta das mãos piores." }], correctOptionId: "coherent", feedback: { short: "A razão é a continuação de mãos piores, não o rótulo ‘range fraco’ isolado." }, sourceKind: "heuristic", variantGroup: "objective-target-fit", learningPackage: "hand-function-vs-range", packageSequence: 6, concept: "objective-target-fit", subconcept: "thin-value-weaker-range", reasoningPattern: "match-hand-function-to-targets", supportNote: "Identifique quem paga pior antes de escolher a ação."
  },
  {
    id: "dev-hand-range-07", purpose: "development", primarySkill: "integrated-decision", support: "independent",
    spot: { label: "Draw sem função automática", pot: "Premissa didática", stack: "100bb", hero: "Herói tem Draw", action: ["As mãos melhores que queremos fazer foldar continuam contra o raise proposto"] }, prompt: "Qual é o problema do raise?", options: [{ id: "no-function", label: "A agressão não cumpre bem sua função se as mãos-alvo não mudam de decisão." }, { id: "draw", label: "Preferir o raise pela equidade do Draw, mesmo sem definir quais mãos melhores precisam foldar." }, { id: "weak", label: "Buscar folds adicionais no range como um todo, embora as mãos melhores relevantes continuem." }], correctOptionId: "no-function", feedback: { short: "Draw não determina agressão. A ação precisa cumprir um objetivo contra mãos-alvo reais." }, sourceKind: "theory", variantGroup: "objective-target-fit", learningPackage: "hand-function-vs-range", packageSequence: 7, concept: "objective-target-fit", subconcept: "draw-without-target", reasoningPattern: "action-without-function"
  },
  {
    id: "dev-hand-range-08", purpose: "development", primarySkill: "integrated-decision", support: "independent",
    spot: { label: "Air · range relativamente fraco", pot: "Premissa didática", stack: "100bb", hero: "Herói tem Air", action: ["As mãos melhores relevantes continuam mesmo contra o tamanho considerado"] }, prompt: "Range fraco sozinho justifica o blefe?", options: [{ id: "targets", label: "Não. Precisamos identificar quais mãos melhores queremos fazer foldar e se elas realmente foldam." }, { id: "bluff", label: "Sim. A presença de mais mãos vulneráveis torna o blefe atraente, mesmo sem identificar quais delas foldam." }], correctOptionId: "targets", feedback: { short: "A leitura do range é só o começo; sem mudança nas mãos-alvo, a agressão não ganha função." }, sourceKind: "theory", variantGroup: "objective-target-fit", learningPackage: "hand-function-vs-range", packageSequence: 8, concept: "objective-target-fit", subconcept: "air-without-target", reasoningPattern: "target-before-aggression"
  },
  {
    id: "dev-hand-range-09", purpose: "development", primarySkill: "integrated-decision", support: "supported",
    spot: { label: "Uma pista isolada", pot: "Flop", stack: "100bb", hero: "Herói", action: ["Apenas um sinal aponta para range forte", "Os outros elementos permanecem inconclusivos"] }, prompt: "Devemos alterar radicalmente a função da nossa mão?", options: [{ id: "calibrate", label: "Ainda não há sustentação para tratar a leitura como certeza; podemos atualizar a hipótese sem reconstruir toda a decisão." }, { id: "radical", label: "Sim. Uma pista de força exige reclassificar toda a estratégia." }, { id: "ignore", label: "Não. Uma pista isolada nunca deve atualizar a leitura." }], correctOptionId: "calibrate", feedback: { short: "A adaptação deve ser proporcional à sustentação da leitura." }, sourceKind: "heuristic", variantGroup: "range-response-calibration", learningPackage: "hand-function-vs-range", packageSequence: 9, concept: "range-response-calibration", subconcept: "single-clue-update", reasoningPattern: "calibrate-strategy-update", supportNote: "Atualize sem transformar hipótese em certeza."
  },
  {
    id: "dev-hand-range-10", purpose: "development", primarySkill: "integrated-decision", support: "independent",
    spot: { label: "Pistas coerentes", pot: "Flop multiway", stack: "100bb", hero: "Herói na fronteira Thin Value/SDV", action: ["Size, configuração e contexto multiway apontam coerentemente para range relativamente forte"] }, prompt: "Por que a adaptação agora possui mais sustentação?", options: [{ id: "coherent-clues", label: "Várias pistas coerentes apoiam a leitura, tornando mais justificável reavaliar a função da mão." }, { id: "certainty", label: "Reclassificar a mão como SDV principalmente pelo size, usando configuração e multiway apenas como confirmação." }, { id: "multiway", label: "Manter Thin Value porque o holding não mudou, usando as pistas apenas para escolher um size menor." }], correctOptionId: "coherent-clues", feedback: { short: "Pistas coerentes sustentam melhor a reavaliação, sem criar certeza ou porcentagem de confiança." }, sourceKind: "heuristic", variantGroup: "range-response-calibration", learningPackage: "hand-function-vs-range", packageSequence: 10, concept: "range-response-calibration", subconcept: "coherent-clues", reasoningPattern: "calibrate-strategy-update"
  },
  {
    id: "dev-hand-range-11", purpose: "development", primarySkill: "integrated-decision", support: "independent",
    spot: { label: "Range é só o começo", pot: "Premissa didática", stack: "100bb", hero: "Herói tem Thin Value", action: ["Leitura: range relativamente fraco", "Objetivo: extrair valor de pares piores", "50%: pares piores continuam", "100%: grande parte abandona"] }, prompt: "Qual raciocínio está completo?", options: [{ id: "chain", label: "Range → função da mão → objetivo → mãos-alvo → resposta ao tamanho → escolher a decisão coerente com os calls a 50%." }, { id: "large", label: "Escolher 100% para ganhar mais quando houver call, apesar de grande parte dos pares piores abandonar." }, { id: "fixed", label: "Tratar a mão como SDV por cautela, sem usar a resposta explícita dos pares piores a 50%." }], correctOptionId: "chain", feedback: { short: "A decisão conecta leitura, função, objetivo, alvos e resposta ao size; o rótulo do range não escolhe o tamanho." }, sourceKind: "theory", variantGroup: "integrated-hand-range-decision", learningPackage: "hand-function-vs-range", packageSequence: 11, concept: "hand-function-context", subconcept: "complete-decision-chain", reasoningPattern: "complete-decision-chain"
  },
  {
    id: "dev-hand-range-12", purpose: "development", primarySkill: "integrated-decision", support: "independent",
    spot: { label: "Integração · mesma mão", pot: "Comparação didática", stack: "100bb", hero: "Herói", action: ["A: range mais fraco bem sustentado; várias mãos piores continuam; mãos melhores pouco mudam", "B: range mais forte bem sustentado; poucas mãos piores continuam; linha de valor mais estreita"] }, prompt: "Qual síntese é mais correta?", options: [{ id: "contextual", label: "A mão não possui função estratégica fixa: o range enfrentado e as mãos-alvo alteram o papel e a decisão." }, { id: "same", label: "Manter a função de Thin Value nos dois cenários e ajustar apenas o tamanho no cenário B." }, { id: "shortcut", label: "No cenário A, ampliar a agressão pela fraqueza relativa; no B, converter a mão em SDV pela força relativa." }], correctOptionId: "contextual", feedback: { short: "A função emerge da relação entre mão, range, objetivo e alvos; não de um rótulo fixo ou atalho binário." }, sourceKind: "heuristic", variantGroup: "integrated-hand-range-decision", learningPackage: "hand-function-vs-range", packageSequence: 12, concept: "hand-function-context", subconcept: "integrated-comparison", reasoningPattern: "integrate-range-and-hand-function"
  },
...
export const evaluationExercises: Exercise[] = [
  ...
  {
    id: "retention-hand-range-01", purpose: "retention", primarySkill: "integrated-decision", support: "independent", spot: { label: "Retenção · mesma mão", pot: "Comparação", stack: "100bb", hero: "Herói", action: ["A: várias mãos piores continuam", "B: poucas mãos piores continuam"] }, prompt: "Como a diferença entre os ranges afeta a função da mesma mão?", options: [{ id: "context", label: "Ela pode mudar porque a quantidade de mãos piores que continua muda entre os cenários." }, { id: "fixed", label: "Ela continua como Thin Value nos dois; basta reduzir o size quando houver menos calls piores." }], correctOptionId: "context", feedback: { short: "A mesma mão pode cumprir papéis diferentes contra ranges diferentes." }, sourceKind: "heuristic", variantGroup: "hand-function-context", learningPackage: "hand-function-vs-range", concept: "hand-function-context", subconcept: "same-hand-different-range", reasoningPattern: "reclassify-hand-by-range"
  },
  {
    id: "retention-hand-range-02", purpose: "retention", primarySkill: "integrated-decision", support: "independent", spot: { label: "Retenção · Thin Value", pot: "Premissa didática", stack: "100bb", hero: "Herói", action: ["Quase todas as mãos piores deixam de continuar contra a aposta"] }, prompt: "O objetivo de value continua funcionando bem?", options: [{ id: "no", label: "Não muito; faltam mãos piores suficientes continuando." }, { id: "yes", label: "Sim; ainda há mãos piores no range, mesmo que elas abandonem contra esta aposta." }], correctOptionId: "no", feedback: { short: "Value depende das mãos piores que continuam." }, sourceKind: "heuristic", variantGroup: "objective-target-fit", learningPackage: "hand-function-vs-range", concept: "objective-target-fit", subconcept: "thin-value-targets", reasoningPattern: "match-hand-function-to-targets"
  },
  {
    id: "retention-hand-range-03", purpose: "retention", primarySkill: "integrated-decision", support: "independent", spot: { label: "Retenção · Draw e Air", pot: "Premissa didática", stack: "100bb", hero: "Herói", action: ["As mãos melhores relevantes não foldam para a agressão considerada"] }, prompt: "Qual avaliação da agressão usa melhor as premissas?", options: [{ id: "function", label: "Ela não cumpre bem o objetivo porque as mãos melhores relevantes continuam." }, { id: "automatic", label: "Ela aproveita a equidade do Draw ou a fraqueza do Air para pressionar o range, mesmo sem mudar as mãos-alvo." }], correctOptionId: "function", feedback: { short: "A categoria não substitui a função da ação." }, sourceKind: "theory", variantGroup: "objective-target-fit", learningPackage: "hand-function-vs-range", concept: "objective-target-fit", subconcept: "aggression-function", reasoningPattern: "target-before-aggression"
  },
  {
    id: "transfer-hand-range-01", purpose: "transfer", primarySkill: "integrated-decision", support: "independent", spot: { label: "Transferência · novo board multiway", pot: "Flop multiway", stack: "100bb", hero: "Herói tem mão intermediária", board: ["K♣", "9♦", "6♠"], action: ["Várias pistas sustentam range mais forte", "Poucas mãos piores continuam contra uma aposta"] }, prompt: "O que deve ser reavaliado?", options: [{ id: "function", label: "A função da mão e o objetivo, considerando as mãos piores que ainda continuam." }, { id: "fold", label: "Manter a mão como Thin Value e apenas reduzir o size por enfrentar um range mais forte." }], correctOptionId: "function", feedback: { short: "A nova superfície mantém a estrutura range → mão → função → alvos." }, sourceKind: "heuristic", variantGroup: "hand-function-context", learningPackage: "hand-function-vs-range", concept: "hand-function-context", subconcept: "transfer-stronger-range", reasoningPattern: "reclassify-hand-by-range"
  },
  {
    id: "transfer-hand-range-02", purpose: "transfer", primarySkill: "integrated-decision", support: "independent", spot: { label: "Transferência · value e size", pot: "Premissa didática", stack: "100bb", hero: "Herói tem Thin Value", action: ["Range relativamente fraco", "50%: várias mãos piores pagam", "100%: essas mãos piores abandonam"] }, prompt: "Qual size se ajusta melhor ao objetivo de extrair value das mãos piores descritas?", options: [{ id: "no", label: "50%, porque mantém as mãos piores que queremos receber call." }, { id: "yes", label: "100%, porque extrai mais quando recebe call, apesar de expulsar essas mãos piores." }], correctOptionId: "no", feedback: { short: "A resposta das mãos-alvo, não o rótulo do range, decide se o size cumpre o objetivo." }, sourceKind: "theory", variantGroup: "objective-target-fit", learningPackage: "hand-function-vs-range", concept: "objective-target-fit", subconcept: "weaker-range-size-boundary", reasoningPattern: "complete-decision-chain"
  },
  {
    id: "transfer-hand-range-03", purpose: "transfer", primarySkill: "integrated-decision", support: "independent", spot: { label: "Transferência · evidência conflitante", pot: "Nova configuração", stack: "100bb", hero: "Herói na fronteira Thin Value/SDV", action: ["Os sinais de força do range apontam em direções diferentes"] }, prompt: "Qual adaptação é mais calibrada?", options: [{ id: "uncertain", label: "Atualizar a hipótese, preservar a incerteza e evitar uma reclassificação rígida da mão." }, { id: "fixed", label: "Dar mais peso ao sinal de size e fixar a mão como SDV, tratando os demais sinais como secundários." }], correctOptionId: "uncertain", feedback: { short: "Evidência conflitante sustenta menos adaptação que várias pistas coerentes." }, sourceKind: "heuristic", variantGroup: "range-response-calibration", learningPackage: "hand-function-vs-range", concept: "range-response-calibration", subconcept: "conflicting-signals", reasoningPattern: "calibrate-strategy-update"
  },
